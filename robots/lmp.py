...
from llms.openai_interface import AISpecInterface
from .globals import *
...
class LMP:
    ...
    def __call__(self, query, context='', **kwargs):
        ...
        while True:
            try:
                code_str = self.llm.create_completion(
                    prompt=prompt,
...
class LMPFGen:
    ...
    def create_f_from_sig(self, f_name, f_sig, other_vars=None, fix_bugs=False, return_src=False):
        ...
        while True:
            try:
                f_src = self.llm.create_completion(
                    prompt=prompt,
                    stop=self._stop_tokens,
                    temperature=self._cfg['temperature'],
                    engine=self._cfg['engine'],
