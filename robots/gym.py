...
class PickPlaceEnv():
  ...
  def reset(self, object_list):
    ...
    self.robot_id = pybullet.loadURDF(RELATIVE_ASSETS_PATH + "ur5e/ur5e.urdf", [0, 0, 0], flags=pybullet.URDF_USE_MATERIAL_COLORS_FROM_MTL)
    self.ghost_id = pybullet.loadURDF(RELATIVE_ASSETS_PATH + "ur5e/ur5e.urdf", [0, 0, -10])  # For forward kinematics.
    ...
    for obj_name in object_list:
      if ('block' in obj_name) or ('bowl' in obj_name):
        ...
        if object_type == 'block':
          ...
          object_position[2] = 0
          object_id = pybullet.loadURDF(RELATIVE_ASSETS_PATH + "bowl/bowl.urdf", object_position, useFixedBase=1)
